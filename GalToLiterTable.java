public class GalToLiterTable {

    /* This new version will print a table of conversions, beginning with 1 gallon and ending at 100 gallons. After
    every 10 gallons, a blank line will be output. this is accomplished through the use of a variable called counter
    that counts number of lines that have been output.*/
    public static void main(String[] args) {
        ...
        for (gallons = 0; gallons < 100; gallons++) {
            ...
            counter++;// incremental the line counter with each loop iteration
            // Ever 10th line, print a blank line
            if (counter == 10){
                System.out.println();
